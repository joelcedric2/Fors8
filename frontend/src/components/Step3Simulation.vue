<template>
  <div class="simulation-panel">
    <!-- Geopolitical Simulation Panel (Tier 1 & 2 strategic actions) -->
    <GeoSimPanel :runStatus="runStatus" />

    <!-- Top Control Bar (OASIS Info Warfare Layer - Tier 3 agents) -->
...
import GeoSimPanel from './GeoSimPanel.vue'
...
const doStartSimulation = async () => {
  ...
  // Reset all state to avoid carryover from previous simulation
  resetAllState()
