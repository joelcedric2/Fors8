...
export default {
  ...
  data() {
    return {
      ...
      providers: [
        {
          ...
          svg: `<svg fill="#e8e9ed" fill-rule="evenodd" viewBox="0 0 24 24" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M13.827 3.52h3.603L24 20h-3.603l-6.57-16.48zm-7.258 0h3.767L16.906 20h-3.674l-1.343-3.461H5.017l-1.344 3.46H0L6.57 3.522zm4.132 9.959L8.453 7.687 6.205 13.48H10.7z"></path></svg>`
        },
        {
          id: 'openai', name: 'OpenAI', desc: 'GPT-4o & o3 — sign in or API key',
          svg: `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 256 260" fill="#e8e9ed"><path d="M239.184 106.203a64.716 64.716 0 0 0-5.576-53.103C219.452 28.459 191 15.784 163.213 21.74A65.586 65.586 0 0 0 52.096 45.22a64.716 64.716 0 0 0-43.23 31.36c-14.31 24.602-11.061 55.634 8.033 76.74a64.665 64.665 0 0 0 5.525 53.102c14.174 24.65 42.644 37.324 70.446 31.36a64.72 64.72 0 0 0 48.754 21.744c28.481.025 53.714-18.361 62.414-45.481a64.767 64.767 0 0 0 43.229-31.36c14.137-24.558 10.875-55.423-8.083-76.483Zm-97.56 136.338a48.397 48.397 0 0 1-31.105-11.255l1.535-.87 51.67-29.825a8.595 8.595 0 0 0 4.247-7.367v-72.85l21.845 12.636c.218.111.37.32.409.563v60.367c-.056 26.818-21.783 48.545-48.601 48.601Zm-104.466-44.61a48.345 48.345 0 0 1-5.781-32.589l1.534.921 51.722 29.826a8.339 8.339 0 0 0 8.441 0l63.181-36.425v25.221a.87.87 0 0 1-.358.665l-52.335 30.184c-23.257 13.398-52.97 5.431-66.404-17.803ZM23.549 85.38a48.499 48.499 0 0 1 25.58-21.333v61.39a8.288 8.288 0 0 0 4.195 7.316l62.874 36.272-21.845 12.636a.819.819 0 0 1-.767 0L41.353 151.53c-23.211-13.454-31.171-43.144-17.804-66.405v.256Zm179.466 41.695-63.08-36.63L161.73 77.86a.819.819 0 0 1 .768 0l52.233 30.184a48.6 48.6 0 0 1-7.316 87.635v-61.391a8.544 8.544 0 0 0-4.4-7.213Zm21.742-32.69-1.535-.922-51.619-30.081a8.39 8.39 0 0 0-8.492 0L99.98 99.808V74.587a.716.716 0 0 1 .307-.665l52.233-30.133a48.652 48.652 0 0 1 72.236 50.391v.205ZM88.061 139.097l-21.845-12.585a.87.87 0 0 1-.41-.614V65.685a48.652 48.652 0 0 1 79.757-37.346l-1.535.87-51.67 29.825a8.595 8.595 0 0 0-4.246 7.367l-.051 72.697Zm11.868-25.58 28.138-16.217 28.188 16.218v32.434l-28.086 16.218-28.188-16.218-.052-32.434Z"/></svg>`
        },
        {
          id: 'openrouter', name: 'OpenRouter', desc: '30+ frontier models — free and paid options',
          svg: `<svg width="22" height="22" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#e8e9ed" stroke="#e8e9ed"><g clip-path="url(#c)"><path d="M3 248.945C18 248.945 76 236 106 219C136 202 136 202 198 158C276.497 102.293 332 120.945 423 120.945" stroke-width="90" fill="none"/><path d="M511 121.5L357.25 210.268L357.25 32.7324L511 121.5Z"/><path d="M0 249C15 249 73 261.945 103 278.945C133 295.945 133 295.945 195 339.945C273.497 395.652 329 377 420 377" stroke-width="90" fill="none"/><path d="M508 376.445L354.25 287.678L354.25 465.213L508 376.445Z"/></g></svg>`
        },
        {
          id: 'vllm', name: 'Self-Hosted GPU', desc: 'Vast.ai + vLLM — run 100K+ agents for ~$5',
          svg: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#e8e9ed" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 1v3m6-3v3M9 20v3m6-3v3M20 9h3M20 15h3M1 9h3M1 15h3"/></svg>`
        },
      ],
      ...
      vllmModels: [
        { id: 'qwen2.5:72b', name: 'Qwen 2.5 72B', gpus: '2x A100 (80GB)', costPerHour: 0.30, sizeGb: 42, strengths: 'Best JSON reliability. Recommended for war prediction.' },
        { id: 'qwen2.5:32b', name: 'Qwen 2.5 32B', gpus: '1x A100 or 2x 4090', costPerHour: 0.15, sizeGb: 20, strengths: 'Good balance of speed and quality.' },
        { id: 'qwen2.5:14b', name: 'Qwen 2.5 14B', gpus: '1x RTX 4090', costPerHour: 0.08, sizeGb: 9, strengths: 'Fast and cheap. Good for testing.' },
        { id: 'deepseek-v3:latest', name: 'DeepSeek V3', gpus: '2x A100 (80GB)', costPerHour: 0.30, sizeGb: 40, strengths: 'Best reasoning accuracy.' },
        { id: 'llama3.1:70b', name: 'Llama 3.1 70B', gpus: '2x A100 (80GB)', costPerHour: 0.30, sizeGb: 42, strengths: 'Balanced, well-tested by community.' },
        { id: 'mistral:7b', name: 'Mistral 7B', gpus: '1x RTX 3090', costPerHour: 0.05, sizeGb: 4, strengths: 'Ultra-fast, cheapest. For quick tests.' },
      ],
...
.page-header h1 { font-size: 24px; font-weight: 700; letter-spacing: -0.3px; margin: 0 0 8px; color: #18181b; }
.page-header p { font-size: 14px; color: #71717a; margin: 0; line-height: 1.5; }

/* Provider Grid */
.provider-grid { display: flex; flex-direction: column; gap: 1px; background: #e4e4e7; border: 1px solid #e4e4e7; border-radius: 10px; overflow: hidden; }
.provider-card { display: flex; align-items: center; gap: 16px; padding: 18px 22px; background: #fafafa; cursor: pointer; transition: background 0.12s; }
.provider-card:hover { background: #f4f4f5; }
.card-logo { width: 42px; height: 42px; display: flex; align-items: center; justify-content: center; background: #18181b; border-radius: 9px; flex-shrink: 0; }
.card-body { flex: 1; }
.card-name { font-weight: 600; font-size: 15px; margin-bottom: 2px; color: #18181b; }
.card-desc { font-size: 13px; color: #71717a; }
.card-arrow { color: #a1a1aa; flex-shrink: 0; transition: transform 0.15s; }
.provider-card:hover .card-arrow { transform: translateX(3px); color: #52525b; }

/* Provider Detail */
.provider-detail { animation: fadeIn 0.2s ease; }
@keyframes fadeIn { from { opacity: 0; transform: translateY(8px); } to { opacity: 1; transform: translateY(0); } }

.detail-back { display: inline-flex; align-items: center; gap: 6px; background: none; border: none; color: #71717a; font-size: 13px; cursor: pointer; padding: 4px 0; margin-bottom: 24px; font-family: inherit; transition: color 0.15s; }
.detail-back:hover { color: #18181b; }
.detail-header { display: flex; align-items: center; gap: 16px; margin-bottom: 32px; }
.detail-logo { width: 48px; height: 48px; display: flex; align-items: center; justify-content: center; background: #18181b; border-radius: 12px; }
.detail-header h2 { font-size: 22px; font-weight: 600; margin: 0 0 2px; letter-spacing: -0.3px; color: #18181b; }
.detail-header p { font-size: 14px; color: #71717a; margin: 0; }

/* Auth Cards */
.auth-cards { display: flex; flex-direction: column; gap: 1px; background: #e4e4e7; border: 1px solid #e4e4e7; border-radius: 10px; overflow: hidden; margin-bottom: 24px; }
.auth-card { display: flex; align-items: center; gap: 14px; padding: 18px 20px; background: #fafafa; cursor: pointer; transition: background 0.12s; }
.auth-card:hover { background: #f4f4f5; }
.auth-card.active { background: #f0f0ff; }
.auth-card-icon { width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; background: #f4f4f5; border-radius: 10px; color: #52525b; }
.auth-card.active .auth-card-icon { background: #e8e8ff; color: #18181b; }
.auth-card-body { flex: 1; }
.auth-card-title { font-weight: 500; font-size: 14px; color: #18181b; }
.auth-card-sub { font-size: 12px; color: #71717a; margin-top: 1px; }
.free-tag { font-size: 10px; font-weight: 700; letter-spacing: 0.5px; color: #16a34a; background: #f0fdf4; padding: 3px 8px; border-radius: 4px; }

/* Forms */
.auth-form { margin-top: 4px; }
.form-group { margin-bottom: 16px; }
.form-group label { display: block; font-size: 13px; font-weight: 500; color: #52525b; margin-bottom: 6px; }
.optional { font-weight: 400; color: #a1a1aa; }
.form-group input, .form-group select { width: 100%; padding: 10px 14px; border: 1px solid #e4e4e7; border-radius: 8px; font-size: 14px; font-family: inherit; background: #fff; color: #18181b; transition: border-color 0.15s; outline: none; }
.form-group input:focus, .form-group select:focus { border-color: #b8860b; box-shadow: 0 0 0 3px rgba(184,134,11,0.06); }
.form-group input::placeholder { color: #a1a1aa; }

.form-divider { text-align: center; position: relative; margin: 20px 0; color: #a1a1aa; font-size: 12px; }
.form-divider::before { content: ''; position: absolute; top: 50%; left: 0; right: 0; height: 1px; background: #e4e4e7; }
.form-divider span { background: #fff; padding: 0 12px; position: relative; }

.btn-primary { width: 100%; padding: 11px 20px; background: #18181b; color: #fff; border: none; border-radius: 8px; font-size: 14px; font-weight: 500; cursor: pointer; font-family: inherit; transition: background 0.15s; }
.btn-primary:hover { background: #333; }
.btn-primary:disabled { background: #e4e4e7; color: #a1a1aa; cursor: not-allowed; }

.status-msg { margin-top: 12px; padding: 10px 14px; border-radius: 8px; font-size: 13px; }
...
.model-search { width: 100%; padding: 10px 14px 10px 38px; border: 1px solid #e4e4e7; border-radius: 8px; font-size: 14px; font-family: inherit; outline: none; background: #fff; color: #18181b; transition: border-color 0.15s; }
.model-search:focus { border-color: #b8860b; }
.model-list { border: 1px solid #e4e4e7; border-radius: 10px; overflow: hidden; max-height: 420px; overflow-y: auto; }
.model-row { display: flex; align-items: center; justify-content: space-between; padding: 12px 16px; cursor: pointer; border-bottom: 1px solid #f4f4f5; transition: background 0.1s; }
.model-row:last-child { border-bottom: none; }
.model-row:hover { background: #fafafa; }
.model-row.selected { background: #f0f0ff; }
.model-info { display: flex; flex-direction: column; gap: 1px; }
.model-name { font-size: 14px; font-weight: 500; color: #18181b; }
.model-provider { font-size: 12px; color: #71717a; }
.model-right { display: flex; align-items: center; gap: 10px; }
.model-free { font-size: 10px; font-weight: 700; color: #16a34a; background: #f0fdf4; padding: 2px 7px; border-radius: 4px; letter-spacing: 0.3px; }
.model-price { font-size: 12px; color: #71717a; font-family: 'IBM Plex Mono', 'SF Mono', 'Menlo', monospace; }
.model-ctx { font-size: 11px; color: #a1a1aa; }

/* GPU Models */
.subsection-title { font-size: 14px; font-weight: 600; margin: 0 0 12px; color: #3f3f46; }
.gpu-model-list { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 28px; }
.gpu-model-card { border: 1px solid #e4e4e7; border-radius: 10px; padding: 14px 16px; cursor: pointer; transition: all 0.12s; background: #fafafa; }
.gpu-model-card:hover { border-color: #a1a1aa; }
.gpu-model-card.selected { border-color: #b8860b; background: #fffbf0; }
.gpu-model-name { font-weight: 600; font-size: 14px; margin-bottom: 4px; color: #18181b; }
.gpu-model-meta { font-size: 12px; color: #71717a; }
.gpu-model-size { font-size: 11px; color: #2563eb; margin-top: 4px; }
.gpu-model-note { font-size: 11px; color: #a1a1aa; margin-top: 4px; }

.provision-note { font-size: 12px; color: #71717a; line-height: 1.5; margin: 0 0 16px; padding: 10px 14px; background: #fafafa; border-radius: 8px; border: 1px solid #e4e4e7; }

.gpu-status-card { border: 1px solid #e4e4e7; border-radius: 10px; padding: 14px 16px; margin-bottom: 16px; background: #fafafa; }
.gpu-status-header { display: flex; align-items: center; gap: 8px; font-weight: 500; font-size: 14px; margin-bottom: 6px; color: #18181b; }
.gpu-status-dot { width: 8px; height: 8px; border-radius: 50%; background: #a1a1aa; }
.gpu-status-dot.running, .gpu-status-dot.ready { background: #16a34a; }
.gpu-status-dot.idle { background: #d97706; }
.gpu-status-dot.provisioning, .gpu-status-dot.loading { background: #2563eb; }
.gpu-status-meta { display: flex; gap: 16px; font-size: 12px; color: #71717a; margin-bottom: 10px; font-family: 'IBM Plex Mono', 'SF Mono', 'Menlo', monospace; }

.btn-destroy { width: 100%; padding: 8px; background: #fff; border: 1px solid #dc2626; border-radius: 8px; color: #dc2626; font-size: 13px; font-weight: 500; cursor: pointer; font-family: inherit; transition: all 0.15s; }
.btn-destroy:hover { background: #fef2f2; }

.scale-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; margin-bottom: 24px; }

.cost-box { background: #fafafa; border: 1px solid #e4e4e7; border-radius: 10px; padding: 20px; text-align: center; margin-bottom: 16px; }
.cost-label { font-size: 12px; color: #71717a; text-transform: uppercase; letter-spacing: 0.5px; }
.cost-value { font-size: 32px; font-weight: 700; font-family: 'IBM Plex Mono', 'SF Mono', 'Menlo', monospace; margin: 4px 0; color: #18181b; }
.cost-detail { font-size: 12px; color: #a1a1aa; }

.vastai-cta { display: flex; align-items: center; justify-content: space-between; padding: 14px 18px; background: #fafafa; border: 1px solid #e4e4e7; border-radius: 10px; margin-bottom: 20px; font-size: 13px; color: #71717a; }
.vastai-link { display: inline-flex; align-items: center; gap: 5px; color: #18181b; font-weight: 500; text-decoration: none; transition: color 0.15s; }
.vastai-link:hover { color: #2563eb; }
</style>
